    ...
    while True:
        ...
        if shortcode == "new":
            ...
            while default_user != "testuser" or default_login != "1000":
                print("Wrong username or password. username 'testuser' and '1000' ")
            ...
            print("Enter a valid code to continue...or just proceed to saving your accounts though not secure")
            print("\n")
            break
